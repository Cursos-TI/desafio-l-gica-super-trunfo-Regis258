...
setlocale(LC_ALL, "Portuguese");
    ...
    if (pib1 > pib2)
    {
        printf("A carta %d (%s) que tem o maior PIB: (%.2f) é a vencedora!\n", carta1, cidade1, pib1);
    }
    else if (pib2 > pib1)
    {
        printf("A carta %d (%s) que tem o maior PIB: (%.2f) é a vencedora!\n", carta2, cidade2, pib2);
    ...
    {
        printf("Nenhuma carta venceu no critério de PIB!\n");
    }

    if (densidade1 < densidade2)
    {
        printf("A carta %d (%s) tem uma densidade populacional menor (%.2f), então venceu! \n", carta1, cidade1, densidade1);
    }
